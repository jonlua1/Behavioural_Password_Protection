...
class OnOffWidget(QGroupBox):
    ...
    def __init__(self, name, uname, password):
        ...
        self.pwd = QLabel(self.password)
        self.pwd.setAlignment(Qt.AlignCenter)
        self.pwd.setSizePolicy(sizePolicy)
        self.pwd.setMinimumSize(QSize(0, 150))
        self.pwd.setStyleSheet("""font-size: 30px; font-family: Trebuchet MS;
        color: white; border-style: none;""")
        self.btns_vault.addWidget(self.pwd)
