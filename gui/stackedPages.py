...
#########################################################################################
        ...
        for x in parameters:
            ...
            item.viewDetails(self.testingFunction)
...
###############################################################################################
    ...
    def testingFunction(self, pwd, username, account):
        ...
        self.gridLayout_dynamic.setContentsMargins(200, 25, 200, 25)
        self.gridLayout_dynamic.setHorizontalSpacing(20)
        ...
        self.userNameLE_dynamic.setMaximumWidth(300)
        self.userNameLE_dynamic.setStyleSheet("border-style: none;")
        self.pwdLE_dynamic = QtWidgets.QLineEdit(pwd)
        self.pwdLE_dynamic.setMaximumWidth(300)
        self.pwdLE_dynamic.setStyleSheet("border-style: none;")
        self.copyButton_dynamic = QtWidgets.QPushButton("Copy")
        self.copyButton_dynamic.setMaximumWidth(200)
        ...
        self.gridLayout_dynamic.addWidget(self.copyButton_dynamic, 2, 2, 1, 1)
